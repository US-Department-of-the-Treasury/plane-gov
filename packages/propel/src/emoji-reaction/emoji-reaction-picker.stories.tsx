...
export const InlineReactions: Story = {
  ...
  render: () => <InlineReactionsStory />,
};

const SearchDisabledStory = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedEmoji, setSelectedEmoji] = useState<string | null>(null);
  ...
  return (
    <div className="space-y-4 p-4">
      <EmojiReactionPicker
        ...
        searchDisabled
        label={
          <button className="px-4 py-2 bg-layer-1 border border-subtle rounded-sm hover:bg-surface-2">No Search</button>
        }
      />
      {selectedEmoji && <div className="text-13">Selected: {selectedEmoji}</div>}
    </div>
...
export const SearchDisabled: Story = {
  ...
  render: () => <SearchDisabledStory />,
};

const CustomSearchPlaceholderStory = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedEmoji, setSelectedEmoji] = useState<string | null>(null);
...
export const CustomSearchPlaceholder: Story = {
  ...
  render: () => <CustomSearchPlaceholderStory />,
};

const CloseOnSelectDisabledStory = () => {
  const [isOpen, setIsOpen] = useState(false);
...
export const CloseOnSelectDisabled: Story = {
  ...
  render: () => <CloseOnSelectDisabledStory />,
};

const InMessageContextStory = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [reactions, setReactions] = useState<EmojiReactionType[]>([
