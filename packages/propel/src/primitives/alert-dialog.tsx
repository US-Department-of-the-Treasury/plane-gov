...
/**
 * Radix-based AlertDialog primitive following shadcn/ui patterns.
 * Use this for confirmation dialogs that require user acknowledgment.
 * Unlike Dialog, AlertDialog cannot be dismissed by clicking outside or pressing Escape.
 *
 * @example
 * ```tsx
 * <AlertDialog>
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      "mt-2 sm:mt-0",
      "inline-flex h-10 items-center justify-center rounded-md px-4 py-2",
      "border border-subtle bg-transparent font-medium text-secondary",
