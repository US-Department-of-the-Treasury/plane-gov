...
export const WORK_ITEM_TRACKER_ELEMENTS = {
  HEADER_ADD_BUTTON: {
    ...
    CYCLE: "sprint_header_add_work_item_button",
  ...
  EMPTY_STATE_ADD_BUTTON: {
    ...
    CYCLE: "sprint_empty_state_add_work_item_button",
  ...
  QUICK_ACTIONS: {
    ...
    CYCLE: "sprint_work_items_quick_actions",
...
export const PROJECT_VIEW_TRACKER_ELEMENTS = {
  ...
  CYCLE_HEADER_SAVE_AS_VIEW_BUTTON: "sprint_header_save_as_view_button",
