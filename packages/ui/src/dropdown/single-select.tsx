    ...
    <Popover open={isOpen} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <PopoverContent
          ...
          sideOffset={4}
          className={cn(
            "z-50 w-48 rounded-sm border-[0.5px] border-strong bg-surface-1 px-2 py-2 text-11 shadow-raised-200 p-0",
            optionsContainerClassName
          )}
        ...
        >
          <Command shouldFilter={false} className="bg-transparent">
            ...
            <CommandList className={cn("max-h-48 space-y-1 overflow-y-scroll px-2 pb-2", !disableSearch && "mt-2")}>
