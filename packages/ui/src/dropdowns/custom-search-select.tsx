              ...
              createPortal(
                ...
                >
                  <Combobox.Options static>
                    <div
                      className={cn(
                        "my-1 overflow-y-scroll rounded-md border-[0.5px] border-subtle-1 bg-surface-1 py-2.5 text-11 focus:outline-none min-w-48 whitespace-nowrap z-50 transition-opacity duration-75",
                        optionsClassName
                      )}
                    >
