export default {
  ...
  project_empty_state: {
    ...
    epics: {
      title: "プロジェクトの目標を Epic にマッピングして簡単に追跡します。",
      description:
        "Epic は相互接続された作業項目で構成されています。プロジェクトフェーズを通じた進捗の監視を支援し、それぞれに特定の締め切りと分析があり、それらのフェーズをどれだけ達成に近づいているかを示します。",
      cta_primary: "最初の Epic を設定",
    },
    epic_work_items: {
      title: "この Epic に表示する作業項目はありません",
      description: "作業項目を作成して、この Epic の監視を開始します。",
      cta_primary: "作業項目を作成",
      cta_secondary: "既存の作業項目を追加",
    },
    views: {
  ...
  workspace_empty_state: {
    ...
    archive_epics: {
      title: "アーカイブされた Epic はまだありません",
      description:
        "プロジェクトを整理するために、完了またはキャンセルされた Epic をアーカイブします。アーカイブされると、ここで見つけられます。",
    },
    ...
    analytics_no_epic: {
      title: "Epic を作成して、作業を整理し、さまざまな段階での進捗を追跡します。",
    },
    analytics_no_intake: {
