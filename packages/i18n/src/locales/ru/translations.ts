export default {
  ...
  epics_description: "Организуйте работу в подпроекты с назначенными руководителями и исполнителями.",
  views_description:
  ...
  workspace_projects: {
    ...
    network: {
      ...
      public: {
        title: "Публичный",
        description: "Доступен всем в интернете",
        disabled_tooltip: "Публичные проекты пока недоступны",
      },
    },
    error: {
      permission: "Недостаточно прав для выполнения действия",
      sprint_delete: "Ошибка удаления цикла",
      epic_delete: "Ошибка удаления модуля",
  ...
  project_epic: {
    add_epic: "Добавить эпик",
    update_epic: "Обновить эпик",
    create_epic: "Создать эпик",
    archive_epic: "Архивировать эпик",
    restore_epic: "Восстановить эпик",
    delete_epic: "Удалить эпик",
    empty_state: {
      general: {
        title: "Связывайте этапы проекта с модулями для удобного отслеживания рабочих элементов.",
        description:
          "Модуль объединяет рабочие элементы по логическому или иерархическому признаку. Используйте модули для контроля этапов проекта. Каждый эпик имеет собственные сроки выполнения и аналитику для отслеживания прогресса.",
        primary_button: {
          text: "Создать первый эпик",
          comic: {
            title: "Модули группируют рабочие элементы по иерархии",
            description: "Примеры группировки: эпик корзины, эпик шасси или эпик склада.",
          },
        },
      },
      no_issues: {
      ...
      sidebar: {
        in_active: "Этот эпик ещё не активен.",
        invalid_date: "Некорректная дата. Укажите правильную дату.",
      },
    },
    quick_actions: {
      archive_epic: "Архивировать эпик",
      archive_epic_description: "Только завершённые или отменённые\nмодули можно архивировать.",
      delete_epic: "Удалить эпик",
    },
    toast: {
      copy: {
        success: "Ссылка на эпик скопирована в буфер обмена",
      },
      delete: {
