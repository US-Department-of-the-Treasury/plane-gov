...
echo "  pnpm db:seed                    # Seed with demo data"
echo "  pnpm db:seed --mode=random      # Seed with random Faker data"
echo "  pnpm db:reset                   # Wipe database and re-seed"
echo ""
echo "  Default login: admin@admin.gov / admin123"
echo ""
