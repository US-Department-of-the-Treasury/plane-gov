...
export function SprintsViewHeader(props: Props) {
  ...
  // hooks
  const { currentProjectFilters, searchQuery, updateFilters, updateSearchQuery } = useSprintFilter();
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        <SprintFiltersSelection filters={currentProjectFilters ?? {}} handleFiltersUpdate={handleFilters} />
      </FiltersDropdown>
    </div>
  );
}
