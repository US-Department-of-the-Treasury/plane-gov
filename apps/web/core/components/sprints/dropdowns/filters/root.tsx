...
// plane imports
import type { TSprintFilters, TSprintGroups } from "@plane/types";
// hooks
...
type Props = {
  ...
  handleFiltersUpdate: (key: keyof TSprintFilters, value: string | string[]) => void;
  isArchived?: boolean;
};
    ...
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="h-full w-full divide-y divide-subtle-1 overflow-y-auto px-2.5 vertical-scrollbar scrollbar-sm">
        ...
        {!isArchived && (
          <div className="py-2">
            <FilterStatus
              appliedFilters={(filters.status as TSprintGroups[]) ?? null}
