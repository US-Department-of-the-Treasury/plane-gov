...
import type { TEpicDistribution, TEpicEstimateDistribution, TEpicPlotType } from "@plane/types";
...
type TEpicProgressStats = {
  distribution: TEpicDistribution | TEpicEstimateDistribution | undefined;
  groupedIssues: Record<string, number>;
  handleFiltersUpdate: (condition: TWorkItemFilterCondition) => void;
  isEditable?: boolean;
  epicId: string;
  noBackground?: boolean;
  plotType: TEpicPlotType;
  roundedTab?: boolean;
...
export const ModuleProgressStats = observer(function ModuleProgressStats(props: TEpicProgressStats) {
  ...
  const currentDistribution = distribution as TEpicDistribution;
  const currentEstimateDistribution = distribution as TEpicEstimateDistribution;
