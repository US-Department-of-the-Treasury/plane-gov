...
import { FilterLead, FilterMembers, FilterStartDate, FilterStatus, FilterTargetDate } from "@/components/epics";
// hooks
...
type Props = {
  ...
  handleDisplayFiltersUpdate: (updatedDisplayProperties: Partial<TEpicDisplayFilters>) => void;
  handleFiltersUpdate: (key: keyof TEpicFilters, value: string | string[]) => void;
    ...
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="h-full w-full divide-y divide-subtle-1 overflow-y-auto px-2.5 vertical-scrollbar scrollbar-sm">
        ...
        {!isArchived && (
          <div className="py-2">
            <FilterStatus
              appliedFilters={(filters.status as TEpicStatus[]) ?? null}
