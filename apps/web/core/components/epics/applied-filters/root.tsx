...
import { AppliedDateFilters, AppliedMembersFilters, AppliedStatusFilters } from "@/components/epics";
// helpers
// types

type Props = {
  appliedFilters: TEpicFilters;
  isFavoriteFilterApplied?: boolean;
  handleClearAllFilters: () => void;
  handleDisplayFiltersUpdate?: (updatedDisplayProperties: Partial<TEpicDisplayFilters>) => void;
  handleRemoveFilter: (key: keyof TEpicFilters, value: string | null) => void;
