...
import type { TLogoProps, TDocumentDetail } from "@plane/types";
...
// queries
import { useUpdateDocument } from "@/store/queries";
...
/**
 * DocumentEditor - Real-time collaborative editor for documents
 *
 * Uses TipTap editor with Hocuspocus for real-time collaboration.
 * Auto-saves via WebSocket - no manual save button needed.
 */
export const DocumentEditor = memo(function DocumentEditor({ workspaceSlug, pageId, page }: DocumentEditorProps) {
  // refs
  ...
  const realtimeConfig: TRealtimeConfig | undefined = useMemo(() => {
    try {
      ...
      // Add query parameters for document
      WS_LIVE_URL.searchParams.set("documentType", "document");
