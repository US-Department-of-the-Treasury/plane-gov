...
// queries
import { useDeleteDocument } from "@/store/queries";
...
export function DeleteDocumentModal({
  ...
  const deletePageMutation = useDeleteDocument();
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-custom-text-400 mb-4">
              ...
              <span className="font-medium text-custom-text-200">&ldquo;{pageName || "Untitled"}&rdquo;</span>? This
              action cannot be undone and all content will be permanently lost.
            </p>
