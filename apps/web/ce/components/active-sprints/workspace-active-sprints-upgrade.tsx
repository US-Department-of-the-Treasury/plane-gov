...
// assets
import ctaL1Dark from "@/app/assets/workspace-active-sprints/cta-l-1-dark.webp?url";
import ctaL1Light from "@/app/assets/workspace-active-sprints/cta-l-1-light.webp?url";
import ctaR1Dark from "@/app/assets/workspace-active-sprints/cta-r-1-dark.webp?url";
import ctaR1Light from "@/app/assets/workspace-active-sprints/cta-r-1-light.webp?url";
import ctaR2Dark from "@/app/assets/workspace-active-sprints/cta-r-2-dark.webp?url";
import ctaR2Light from "@/app/assets/workspace-active-sprints/cta-r-2-light.webp?url";
// components
...
export const WORKSPACE_ACTIVE_SPRINTS_DETAILS = [
  ...
  {
    key: "get_snapshot_of_each_active_sprint",
  ...
  {
    key: "zoom_into_sprints_that_need_attention",
      ...
      >
        <div className="relative flex flex-col justify-center gap-7 px-14 lg:w-1/2">
          <div className="flex max-w-64 flex-col gap-2">
            <h2 className="text-20 font-semibold">{t("on_demand_snapshots_of_all_your_sprints")}</h2>
            <p className="text-14 font-medium text-tertiary">{t("active_sprints_description")}</p>
          </div>
