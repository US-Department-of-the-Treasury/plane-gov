...
<body>
    ...
    <div class="card">
        ...
        <form id="autoRegForm">
            ...
            <input type="url" id="federationUrl" value="https://fpki-validator.awsdev.treasury.gov/fpki-validator" placeholder="https://fpki-validator.example.gov/fpki-validator" required>
