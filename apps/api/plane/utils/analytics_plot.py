...
def burndown_plot(queryset, slug, project_id, plot_type, sprint_id=None, epic_id=None):
    # Total Issues in Sprint or Epic
    ...
    if estimate_type and plot_type == "points" and epic_id:
        issue_estimates = Issue.issue_objects.filter(
            workspace__slug=slug,
            project_id=project_id,
